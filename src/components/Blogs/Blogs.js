        ...
        <section className='bg-stone-600 p-6'>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 h-screen items-center gap-4 text-white'>
                ...
                <article className="border h-100 p-7 mx-4">
                    ...
                    <p>Semantic HTML, also known as semantic markup, is HTML that adds meaning to a web page rather than merely making it look pretty. A p> tag, for example, denotes that the contained text is a paragraph. Because people understand what paragraphs are and how to display them, this is both semantic and presentational.</p>
                </article>
